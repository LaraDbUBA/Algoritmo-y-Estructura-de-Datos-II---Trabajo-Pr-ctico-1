...
{\In idNuevoUsuario: \Z, \In referidor: \Tipo{Usuario}, \Inout a: \Tipo{AirMiles}}{}
   ...
   \asegura{\existe{u}{\Tipo{Usuario}}{u \in a.usuarios \land u.id = idNuevoUsuario \land u.millasTotales = 500 \land u.millasDisponibles = 500 \land u.historial = [] \land u.categoria = Bronce}}
    \asegura{\paraTodo{u}{\Tipo{Usuario}}{u \in A0.usuarios \land u \neq referidor \implicaLuego u \in a.usuarios}}
    \asegura{\#a.usuarios = \#A0.usuarios + 1}
    \asegura{\existe{u}{\Tipo{Usuario}}{u.id = referidor.id \land u.millasDisponibles = referidor.millasDisponibles + 500 \land u.millasTotales = referidor.millasTotales + 500 \land u.historial = referidor.historial ++ \land u.categoria = queCategoriaEs(u.millasTotales,a)}}
    \asegura{a.promociones = A0.promociones}
