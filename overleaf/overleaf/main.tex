...
{\In idNuevoUsuario: \Z, \In referidor: \Tipo{Usuario}, \Inout a: \Tipo{AirMiles}}{}
   ...
   \aseguraLargo{\existe{u}{\Tipo{Usuario}}{esUsuarioRegistrado(u.id, a) \land u.id = idNuevoUsuario \land u.millasTotales = 500 \land u.millasDisponibles = 500 \land u.historial = [] \land u.categoria = Bronce}}
    ...
    \asegura{\#a.usuarios = \#A0.usuarios + 1}
    \aseguraLargo{\existe{u}{\Tipo{Usuario}}{esUsuarioRegistrado(u.id,a) \land tienenMismoId(u, referidor) \land u.millasDisponibles = referidor.millasDisponibles + 500 \land u.millasTotales = referidor.millasTotales + 500 \land u.historial = referidor.historial ++ []\land u.categoria = queCategoriaEs(u.millasTotales,a)}}
    \asegura{a.promociones = A0.promociones}
...
{\In u: \Tipo{Usuario}, \In cantMillas: \Z, \In premio: \Tipo{T}, \Inout a: \Tipo{AirMiles}}{}
    \requiereLargo{cantMillas > 0 \land esUsuarioRegistrado(u.id,a) \land a = A0 \land tieneSaldoSuficiente(u, cantMillas) \land NoSuperaMillasTotales(u, cantMillas)}
    \asegura{\#A0.usuarios = \#a.usuarios}
    \aseguraLargo{\existe{u_0}{\Tipo{Usuario}}{esUsuarioRegistrado(u_0.id,a) \land tienenMismoId(u_0, u) \land u_0.millasDisponibles = u.millasDisponibles - cantMillas \land tienenMismasMillasTotales(u, u_0) \land u_0.historial = u.historial ++[] \land tienenMismaCategoria(u, u_0)}}
...
{\In cantMillas: \Z, \In usuarioOrigen: \Tipo{Usuario}, \In usuarioDestino: \Tipo{Usuario}, \Inout a: \Tipo{AirMiles}}{}
    \requiereLargo{esUsuarioRegistrado(usuarioDestino.id, a) \land esUsuarioRegistrado(usuarioOrigen.id, a) \land cantMillas \geq 0 \land tieneSaldoSuficiente(usuarioOrigen, cantMillas) \land usuarioDestino \neq usuarioOrigen \land a = A0 \land NoSuperaMillasTotales(usuarioDestino, cantMillas)}
    ...
    \asegura{\#A0.usuarios = \#a.usuarios}
    \aseguraLargo{\existe{u_0}{\Tipo{Usuario}}{esUsuarioRegistrado(u_0.id, a) \land tienenMismoId(u_0, usuarioOrigen) \land u_0.millasDisponibles = usuarioOrigen.millasDisponibles - cantMillas \land tienenMismasMillasTotales(u_0, usuarioOrigen) \land u_0.historial = usuarioOrigen.historial ++ [] \land tienenMismaCategoria(u_0, usuarioOrigen)}}
    \aseguraLargo{\existe{u_0}{\Tipo{Usuario}}{esUsuarioRegistrado(u_0,a) \land tienenMismoId(u_0, usuarioDestino) \land u_0.millasDisponibles = usuarioDestino.millasDisponibles + cantMillas \land tienenMismasMillasTotales(u_0, usuarioDestino) \land u_0.historial = usuarioDestino.historial ++ [] \land tienenMismaCategoria(u_0, usuarioDestino)}}
\end{proc}
...
{\In nombre: \cha, \In factor: \ent, \Inout  a: AirMiles}{}
    ...
    \asegura{\existe{p}{\Tipo{Promocion}}{esPromocionDelSistema(p, a) \land p.nombre = nombre \land p.factor = factor \land p.estado = True}}
...
{\In nombre: \cha, \Inout a: \Tipo{AirMiles}}{}
    ...
    \asegura{\existe{p}{\Tipo{Promocion}}{p.nombre = nombre \land p.estado = False \land esPromocionDelSistema(p, a) }}
